...
export default function Log() {
    ...
    const fetchLogs = async () => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:8081/api/bridge/request/history?${params}`);
        ...
        <div className="flex flex-col h-full">
            <header className="mb-5">
                ...
                <div className="text-white slow-font">
                    <p>Show {rawData.total_elements} Log, Page  {page} of {rawData.total_pages} </p>
                </div>
            </header>
            <main className="flex flex-col gap-2">
                ...
                <div className="absolute flex justify-center gap-3 text-white bottom-2 left-1/2 -translate-1/2">                  
                    <button 
                    ...
                    <button className="w-[35.5px] p-1 px-2 text-sm text-white transition-colors border border-gray-700 rounded-lg bg-gray-800/50 hover:bg-gray-700/50 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        {page}
                    </button>
                    <button 
